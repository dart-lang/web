...
bool isSubtypeOf(Type a, Type b) {
  ...
  if (nameA == 'NamedDeclaration' && nameB == 'JSObject') {
    print('DEBUG: isSubtypeOf(NamedDeclaration, JSObject)');
    print('DEBUG: hierarchyA: $hierarchyA');
  }
...
Type getGreatestCommonSubtypeOfTypes(
  ...
  for (final candidate in repTypes) {
    ...
    if (isGcs) {
      return candidate..isNullable = isNullable;
    }
  }

...
///
/// > **Note:** This interface is called `HTMLCollection` for historical reasons
...
extension type Document._(JSObject _) implements Node, JSObject {
  ...
  external EventHandler get onDoubleClick;
  external set onDoubleClick(EventHandler value);
  ...
  external EventHandler get onSeek;
  external set onSeek(EventHandler value);

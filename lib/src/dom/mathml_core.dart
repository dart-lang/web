...
extension type MathMLElement._(JSObject _) implements Element, JSObject {
  ...
  /// Creates a(n) [MathMLElement] using the tag 'mtext'.
  MathMLElement.mtext()
      : _ = document.createElementNS(
          'http://www.w3.org/1998/Math/MathML',
          'mtext',
  ...
  /// Creates a(n) [MathMLElement] using the tag 'mi'.
  MathMLElement.mi()
      : _ = document.createElementNS(
          'http://www.w3.org/1998/Math/MathML',
          'mi',
  ...
  /// Creates a(n) [MathMLElement] using the tag 'mn'.
  MathMLElement.mn()
      : _ = document.createElementNS(
          'http://www.w3.org/1998/Math/MathML',
          'mn',
  ...
  /// Creates a(n) [MathMLElement] using the tag 'mo'.
  MathMLElement.mo()
      : _ = document.createElementNS(
          'http://www.w3.org/1998/Math/MathML',
          'mo',
  ...
  /// Creates a(n) [MathMLElement] using the tag 'mspace'.
  ...
  /// Creates a(n) [MathMLElement] using the tag 'ms'.
  MathMLElement.ms()
      : _ = document.createElementNS(
          'http://www.w3.org/1998/Math/MathML',
          'ms',
  ...
  /// Creates a(n) [MathMLElement] using the tag 'mrow'.
  MathMLElement.mrow()
      : _ = document.createElementNS(
          'http://www.w3.org/1998/Math/MathML',
          'mrow',
  ...
  /// Creates a(n) [MathMLElement] using the tag 'mfrac'.
  MathMLElement.mfrac()
      : _ = document.createElementNS(
          'http://www.w3.org/1998/Math/MathML',
          'mfrac',
  ...
  /// Creates a(n) [MathMLElement] using the tag 'msqrt'.
  MathMLElement.msqrt()
      : _ = document.createElementNS(
          'http://www.w3.org/1998/Math/MathML',
          'msqrt',
  ...
  /// Creates a(n) [MathMLElement] using the tag 'mroot'.
  MathMLElement.mroot()
      : _ = document.createElementNS(
          'http://www.w3.org/1998/Math/MathML',
          'mroot',
  ...
  /// Creates a(n) [MathMLElement] using the tag 'mstyle'.
  ...
  /// Creates a(n) [MathMLElement] using the tag 'merror'.
  ...
  /// Creates a(n) [MathMLElement] using the tag 'mpadded'.
  ...
  /// Creates a(n) [MathMLElement] using the tag 'mphantom'.
  ...
  /// Creates a(n) [MathMLElement] using the tag 'msub'.
  MathMLElement.msub()
      : _ = document.createElementNS(
          'http://www.w3.org/1998/Math/MathML',
          'msub',
  ...
  /// Creates a(n) [MathMLElement] using the tag 'msup'.
  MathMLElement.msup()
      : _ = document.createElementNS(
          'http://www.w3.org/1998/Math/MathML',
          'msup',
  ...
  /// Creates a(n) [MathMLElement] using the tag 'msubsup'.
  ...
  /// Creates a(n) [MathMLElement] using the tag 'munder'.
  ...
  /// Creates a(n) [MathMLElement] using the tag 'mover'.
  MathMLElement.mover()
      : _ = document.createElementNS(
          'http://www.w3.org/1998/Math/MathML',
          'mover',
  ...
  /// Creates a(n) [MathMLElement] using the tag 'munderover'.
  ...
  /// Creates a(n) [MathMLElement] using the tag 'mmultiscripts'.
  ...
  /// Creates a(n) [MathMLElement] using the tag 'mprescripts'.
  ...
  /// Creates a(n) [MathMLElement] using the tag 'mtable'.
  ...
  /// Creates a(n) [MathMLElement] using the tag 'mtr'.
  MathMLElement.mtr()
      : _ = document.createElementNS(
          'http://www.w3.org/1998/Math/MathML',
          'mtr',
  ...
  /// Creates a(n) [MathMLElement] using the tag 'mtd'.
  MathMLElement.mtd()
      : _ = document.createElementNS(
          'http://www.w3.org/1998/Math/MathML',
          'mtd',
  ...
  /// Creates a(n) [MathMLElement] using the tag 'maction'.
  ...
  /// Creates a(n) [MathMLElement] using the tag 'semantics'.
  ...
  /// Creates a(n) [MathMLElement] using the tag 'annotation'.
  ...
  /// Creates a(n) [MathMLElement] using the tag 'annotation-xml'.

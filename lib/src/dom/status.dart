...
/// Browser compatibility data status.
///
...
class BcdStatus {
  ...
  /// Browser compatibility data status - the status of this API and the list of
  /// supported browsers.
  ///
  /// - `status` is one or more of `standards-track`, `experimental`, and
  /// `deprecated`.
  /// - `browsers` is zero or more of `chrome`, `firefox`, and `safari`.
  ///
  /// ## `status` field
  ///
  /// One or more of `standards-track`, `experimental`, and `deprecated`.
  ///
  /// ### `standards-track`
  ///
  ...
  /// ## `browsers` field
  ///
  /// The browsers that support this feature. This is zero or more of `chrome`,
  /// `firefox`, and `safari`.
  ///
  /// ## See also
  ///
  ...
  const BcdStatus(this.status, {required this.browsers});
}

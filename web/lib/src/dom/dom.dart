...
extension type NodeList._(JSObject _) implements JSObject, JSIterable<Node> {
  ...
  Iterable<Node> get toDart => toDartIterable;
}
...
extension type DOMTokenList._(JSObject _)
    implements JSObject, JSIterable<JSString> {
  ...
  external String get value;
  external set value(String value);
  Iterable<String> get toDart => toDartIterable.map((e) => e.toDart);
}

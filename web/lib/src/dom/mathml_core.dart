...
extension type MathMLElement._(JSObject _) implements Element, JSObject {
  ...
  MathMLElement.mi()
    : _ = document.createElementNS('http://www.w3.org/1998/Math/MathML', 'mi');

  /// Creates a [MathMLElement] using the tag 'mn'.
  MathMLElement.mn()
    : _ = document.createElementNS('http://www.w3.org/1998/Math/MathML', 'mn');

  /// Creates a [MathMLElement] using the tag 'mo'.
  MathMLElement.mo()
    : _ = document.createElementNS('http://www.w3.org/1998/Math/MathML', 'mo');
  ...
  MathMLElement.ms()
    : _ = document.createElementNS('http://www.w3.org/1998/Math/MathML', 'ms');
  ...
  MathMLElement.mtr()
    : _ = document.createElementNS('http://www.w3.org/1998/Math/MathML', 'mtr');

  /// Creates a [MathMLElement] using the tag 'mtd'.
  MathMLElement.mtd()
    : _ = document.createElementNS('http://www.w3.org/1998/Math/MathML', 'mtd');

...
extension type SVGPathSegment._(JSObject _) implements JSObject {
  external String get type;
  external set type(String value);
  external JSArray<JSNumber> get values;
  external set values(JSArray<JSNumber> value);
}
extension type SVGPathDataSettings._(JSObject _) implements JSObject {
  external factory SVGPathDataSettings({bool normalize});
...
extension type SVGPathElement._(JSObject _)
  ...
  external SVGPathSegment? getPathSegmentAtLength(num distance);
  external JSArray<SVGPathSegment> getPathData([SVGPathDataSettings settings]);
  external void setPathData(JSArray<SVGPathSegment> pathData);

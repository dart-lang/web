...
extension type AuthenticationExtensionsClientOutputsJSON._(JSObject _)
  ...
  external AuthenticationExtensionsPRFOutputsJSON get prf;
  external set prf(AuthenticationExtensionsPRFOutputsJSON value);
  external AuthenticationExtensionsLargeBlobOutputsJSON get largeBlob;
  external set largeBlob(AuthenticationExtensionsLargeBlobOutputsJSON value);
}
...
extension type AuthenticationExtensionsPRFOutputsJSON._(JSObject _)
    implements JSObject {
  external factory AuthenticationExtensionsPRFOutputsJSON({
    bool enabled,
  ...
  external bool get enabled;
  external set enabled(bool value);
  external AuthenticationExtensionsPRFValuesJSON get results;
  external set results(AuthenticationExtensionsPRFValuesJSON value);
}
...
extension type AuthenticationExtensionsLargeBlobOutputsJSON._(JSObject _)
    implements JSObject {
  external factory AuthenticationExtensionsLargeBlobOutputsJSON({
    bool supported,
  ...
  external bool get supported;
  external set supported(bool value);
  external Base64URLString get blob;
  external set blob(Base64URLString value);
  external bool get written;
  external set written(bool value);
}

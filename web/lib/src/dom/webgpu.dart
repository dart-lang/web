...
extension type GPUSupportedLimits._(JSObject _) implements JSObject {
  ...
  external int get maxStorageBuffersInVertexStage;
  external int get maxStorageBuffersInFragmentStage;
  external int get maxStorageTexturesPerShaderStage;
  external int get maxStorageTexturesInVertexStage;
  external int get maxStorageTexturesInFragmentStage;
...
extension type $GPUTextureUsage._(JSObject _) implements JSObject {
  ...
  static const GPUFlagsConstant TRANSIENT_ATTACHMENT = 32;
}

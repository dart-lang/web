...
typedef SFrameCipherSuite = String;
...
extension type SFrameTransformOptions._(JSObject _) implements JSObject {
  ...
  external SFrameCipherSuite get cipherSuite;
  external set cipherSuite(SFrameCipherSuite value);
}
extension type SFrameSenderTransform._(JSObject _) implements JSObject {
  external factory SFrameSenderTransform([SFrameTransformOptions options]);
...
extension type SFrameReceiverTransform._(JSObject _)
    implements EventTarget, JSObject {
  external factory SFrameReceiverTransform([SFrameTransformOptions options]);

  external JSPromise<JSAny?> addDecryptionKey(
    CryptoKey key,
    CryptoKeyID keyId,
  );
  external JSPromise<JSAny?> removeDecryptionKey(CryptoKeyID keyId);
  external EventHandler get onerror;
  external set onerror(EventHandler value);
}
extension type SFrameEncrypterStream._(JSObject _)
    implements EventTarget, JSObject {
  external factory SFrameEncrypterStream([SFrameTransformOptions options]);
...
extension type SFrameDecrypterStream._(JSObject _)
    implements EventTarget, JSObject {
  external factory SFrameDecrypterStream([SFrameTransformOptions options]);

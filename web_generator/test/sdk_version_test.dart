...
void main() {
  test('sdkVersion aligns with pubspec.yaml', () {
    ...
    if (sdkConstraint is VersionRange) {
      expect(
        sdkVersion,
        equals(sdkConstraint.min),
        reason:
            'sdkVersion $sdkVersion does not match minimum of constraint '
            '${sdkConstraint.min}',
      );
    } else if (sdkConstraint is Version) {
      expect(
        sdkVersion,
        equals(sdkConstraint),
        reason:
            'sdkVersion $sdkVersion does not match constraint $sdkConstraint',
      );
    } else {
